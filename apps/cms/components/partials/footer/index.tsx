...
const PharaanaFooter = () => {
	return (
		<FooterContent>
			<div className=" md:flex items-center justify-center text-default-600 hidden">
				<div className="text-center md:ltr:text-center md:rtl:text-center text-sm">
					COPYRIGHT &copy; {new Date().getFullYear()} Genie Light Egypt. All rights reserved.
				</div>
			...
			{/* <div className="flex md:hidden justify-around items-center">
				...
				>
					<div className="h-[50px] w-[50px] rounded-full relative left-[0px] top-[0px] custom-dropshadow bg-gray-200 flex items-center justify-center">
						<Icon
