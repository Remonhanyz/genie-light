...
>(({className, color, ...props}, ref) => (
	<div
		ref={ref}
		className={cn(
			"border border-default-200 text-default-700 text-sm font-normal  bg-background flex items-center justify-center px-3 first:border-r-0 last:border-l-0 first:rounded-l-md last:rounded-r-md group-focus-within:border-default dark:group-focus-within:border-default-500 ring-default  transition duration-300",
			className,
			{
