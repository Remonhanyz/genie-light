...
type InputColor = "default" | "primary" | "secondary" | "success" | "info" | "warning" | "destructive";
type SelectSize = "sm" | "default" | "md" | "lg";

const selectVariants = cva(
  "w-full px-3 h-10 text-sm flex [&>svg]:h-5 [&>svg]:w-5 rounded-md border border-input justify-between items-center bg-background disabled:cursor-not-allowed disabled:opacity-50 transition duration-300",
  {
    variants: {
      color: {
        default:
          "border-default-200 text-default-900 focus:outline-none focus:border-default-500/50 disabled:bg-default-200 placeholder:text-muted-foreground [&>svg]:stroke-default-600",
        primary:
